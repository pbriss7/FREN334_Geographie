...
<!-- Opposition entre la mesure scientifique de l'espace et l'interprétation littéraire de l'espace, tenant compte des connotations et du ressenti du lecteur. -->

<!-- La carte n'est pas une simple illustration, mais une interprétation qui implique des choix. Le but de notre discussion est de comprendre la nature de ces choix et leurs conséquences. -->
...
<!-- Le "Paris" de qui ? Du personnage ? Du narrateur ? -->

<!-- Le "Paris" de quand ? Celui de l'intrigue (ex: 1819) ? Celui de l'écriture (ex: 1835) ? Le nôtre ? -->

<!-- Quelles frontières ? Paris intra-muros ? Faut-il inclure les banlieues de l'époque ? La carte doit-elle représenter la ville comme un simple point ou comme une surface ? -->

<!-- Conclure sur la notion de l'instabilité sémantique du toponyme. -->
...
<!-- Nécessité de recourir à des cartes historiques. -->

<!-- Le risque d'anachronisme (projeter la géographie actuelle sur le passé). -->

<!-- Le problème des homonymes (ex: Paris, Texas). -->

<!-- Animateur : Souligner que le géoréférencement n'est pas un processus neutre mais une enquête historique. -->
...
<!-- Conroy propose une double typologie: -->

<!-- Pour remplacer real/fictionnal -->

<!-- 1. "historical" if they also occur in historical documents -->

<!-- 2. "non-historical" if they don't. -->

<!-- 1. Les lieux occupés ("experienced"): visited and inhabited by the characters -->

<!-- 2. Les lieux référencés ("referenced"): mentioned, or imagined by the narrator or the characters. -->

<!-- Barbara Piatti propose cinq (5) catégories d'espace: -->

<!-- 1. Setting: là où l'action prend place (ville, quartier); -->
